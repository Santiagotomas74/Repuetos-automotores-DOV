...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-[#0b2a5b] to-[#0a2a55] text-white pt-16 pb-8 px-6 md:px-12 lg:px-20 xl:px-32 font-sans border-t-4 border-blue-600">
        ...
        <div className="border-t border-[#1E293B] pt-8 flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              aria-label="LinkedIn"
              className="bg-[#162032] text-gray-400 hover:text-white hover:bg-[#0A66C2] p-2.5 rounded-full transition-all duration-300 hover:-translate-y-1"
            >
            ...
            <a
              ...
              className="bg-[#162032] text-gray-400 hover:text-white hover:bg-pink-600 p-2.5 rounded-full transition-all duration-300 hover:-translate-y-1"
            >
              <svg
                className="w-4 h-4"
                fill="none"
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="bg-[#162032] text-gray-400 hover:text-white hover:bg-[#25D366] p-2.5 rounded-full transition-all duration-300 hover:-translate-y-1"
            >
              <FaWhatsapp size={20} />
            </a>
          </div>
